...
public class Patient implements Comparable< Patient>,Serializable {
	 ...
	 * {@code int} maxDiseases- 
	 *  this parameter used to initiate the {@code diseaseIds} array.
	 * {@code int maxExposures}-
	 *  Use this parameter to initiate the {@code exposures }array.
	 * 
	...
	/**
	 *
	 * {@code	addDiseseId(UUID diseaseId)}-this method will add the supplied diseaseId to the diseaseIds array.
	 * 
	 * @return	 void
	 * @param	diseaseId
	 * @throws
	 ...
	 * if the diseaseIds array is full.
	 */
	...
	/**
	 * 
	 * {@code	addExposure(Exposure exposure)}- this method will add the supplied exposure to the exposures array. 
	 * 
	 * @param exposure
	 * 
	 * @throws	  
	...
	/**
	 * compareTo allow Patient class to be sortable in ascending order
	 *  by the last name, then first name.
