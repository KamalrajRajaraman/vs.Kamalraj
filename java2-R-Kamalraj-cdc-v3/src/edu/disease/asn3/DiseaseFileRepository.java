...
public class DiseaseFileRepository {
	 ...
	 * file named patients. Set both the deserialized disease and patient
	 * arrays to an instance of the Disease AndPatient class and return that
	 * instance. Throw an IllegalArgumentException with an appropriate message if
	 * the supplied folder path is null.
	 * 
	 * @param folderPath
	 * @return
